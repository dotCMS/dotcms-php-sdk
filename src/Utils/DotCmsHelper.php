...
class DotCmsHelper
{
    ...
    {
        return '
/* DotCMS SDK - Empty Container Placeholder for UVE (Adaptive Theme) */
.empty-container-placeholder {
    ...
    /* Adaptive theming - inherits parent background */
    background-color: transparent;
    
    /* Use CSS system colors for automatic dark/light adaptation */
    color: CanvasText;
    border-color: CanvasText;
    
    /* Reduce opacity for subtle appearance */
    opacity: 0.6;
}
...
.empty-container-placeholder:hover {
    ...
    /* Subtle background on hover using semi-transparent overlay */
    background-color: color-mix(in srgb, CanvasText 8%, transparent);
}

/* Fallback for older browsers that don\'t support CanvasText */
